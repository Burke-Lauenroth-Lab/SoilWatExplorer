...
public class JMapViewer extends JPanel implements TileLoaderListener {
    ...
    protected void initializeZoomSlider() {
        ...
        zoomSlider.setBounds(10, 15, 30, 150);
        ...
        zoomInButton.setBounds(4, 160, size, size);
        ...
        zoomOutButton.setBounds(8 + size, 160, size, size);
        ...
        folder.setBounds(0, 0, 200, 19);
        folder.setFont(new Font("Dialog", Font.PLAIN, 10));
